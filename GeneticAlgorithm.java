...
public class GeneticAlgorithm {
  ...
  private static int timeout=300000;
	...
	public void makeNextGen() {
		...
		while (tngSize < populationSize) {
			...
			if (rand.nextDouble()<crossoverRate) {
				...
				// child = Chromo.singlepoint_crossover(parent1,parent2);
			}
	...
	public static void main(String[] args)  throws Exception {
		...
		File file = new File("Problem1_1_-4_9.txt");
		// File file = new File("Problem2_19_47_-90.txt");
		//File file = new File("Problem3_-100_-32_-7.txt");
		// File file = new File("Problem4_1570_-3200_-6053.txt");
		...
		for (int test=0; test<numTests; test++) {
			...
			FileWriter fw = new FileWriter(new File ("test"+test+"_output.txt"), false);
